...
class Client extends Model
{
    ...
    {
        return $this->belongsToMany(Property::class, 'client_saved_properties', 'client_id', 'property_id')
                    ->withTimestamps();
    }

    public function viewedProperties()
    {
        return $this->belongsToMany(Property::class, 'client_viewed_properties', 'client_id', 'property_id')
    ...
    {
        return $this->hasMany(BrokerClientRelationship::class);
    }

    public function communicationWorkflows()
    {
        return $this->hasMany(CommunicationWorkflow::class);
    }
