...
class DemoWithImagesSeeder extends Seeder
{
    public function run(): void
    {
        $this->command->info('🚀 Setting up GeoCasa Bohol Demo with Real Images...');
        ...
        $this->command->info('');
        $this->command->info('🎉 Demo with Real Images Setup Complete!');
        $this->command->info('');
        ...
        $this->command->info('');
        $this->command->info('🏠 Properties created with real images:');
        $this->command->info('   • Beachfront Paradise - Panglao Island (3 images)');
        $this->command->info('   • Mountain View Agricultural Land - Carmen (2 images)');
        $this->command->info('   • Commercial Lot - Tagbilaran City Center (2 images)');
        $this->command->info('');
