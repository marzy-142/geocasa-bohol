    ...
    public function run(): void
    {
        ...
        $properties = [
            ...
            [
                ...
                'electricity_available' => true,
                'internet_available' => true,
                'nearby_landmarks' => json_encode(['Dauis Church', 'Dauis Market', 'Beach Access']),
                'is_featured' => false,
                'images' => json_encode(['residential_0.jpg', 'residential_1.jpg']),
                'broker_id' => $maria->id,
            ],
            [
                ...
                'electricity_available' => false,
                'internet_available' => false,
                'nearby_landmarks' => json_encode(['Ubay Market', 'Irrigation System', 'Farming Area']),
                'is_featured' => false,
                'images' => json_encode(['agricultural_0.jpg', 'agricultural_1.jpg']),
                'broker_id' => $ana->id,
            ],
        ];
