    ...
    >
        <div class="flex items-start justify-between mb-6">
            <div class="flex items-center gap-4">
                <div :class="['w-14 h-14 rounded-2xl flex items-center justify-center shadow-soft', colorClasses.bg]">
                    <component 
                        :is="icon" 
                ...
                <div>
                    <h3 class="text-sm font-semibold text-neutral-600 uppercase tracking-wide">{{ title }}</h3>
                    <p v-if="subtitle" class="text-xs text-neutral-500 mt-1">{{ subtitle }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div v-if="trend" class="flex items-center gap-2">
                <div :class="[
                    ...
                    trend.direction === 'up' ? 'bg-accent-50 text-accent-700' : 
                    trend.direction === 'down' ? 'bg-red-50 text-red-700' : 'bg-neutral-50 text-neutral-700'
                ]">
                    <svg 
