...
const highPriorityCount = computed(
    () => reminders.value.summary.high_priority_count
);
...
onMounted(() => {
    ...
    intervalId = setInterval(fetchReminders, 5 * 60 * 1000);
});
...
<template>
    <div
        v-if="showWidget && (totalReminders > 0 || loading)"
    ...
    >
        ...
        <!-- Reminders List -->
        <div
            v-else-if="allReminders.length > 0"
        ...
        <!-- Footer -->
        <div
            v-if="totalReminders > props.maxItems"
