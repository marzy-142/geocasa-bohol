            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <p class="text-neutral-300 mb-6 max-w-md">
                        Your trusted partner in finding the perfect real estate
                        opportunities across the beautiful island of Bohol.
                        Licensed brokers, verified properties, secure
                        transactions.
                    </p>
                    <div class="flex gap-4">
                        <a
                            href="mailto:info@geocasabohol.com"
                            class="w-10 h-10 bg-neutral-800 rounded-xl flex items-center justify-center hover:bg-primary-600 transition-colors cursor-pointer group"
                        >
                            <EnvelopeIcon
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <Link
                                :href="route('home')"
                                class="text-neutral-300 hover:text-primary-400 transition-colors flex items-center gap-2"
                            >
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-neutral-300">
                        <li class="flex items-center gap-3">
                            ...
                            />
                            <span class="text-sm"
                                >Tagbilaran City, Bohol, Philippines</span
                            >
                        </li>
                        <li class="flex items-center gap-3">
                            <PhoneIcon
                ...
                >
                    <div class="text-center md:text-left">
                        <p class="text-neutral-400 text-sm">
                            &copy; {{ currentYear }} GeoCasa Bohol. All rights
                            reserved.
                        </p>
                        <p class="text-neutral-500 text-xs mt-1">
                            Connecting dreams with reality in the heart of
                            Bohol.
                        </p>
                    </div>

                    <div
                        class="flex items-center gap-6 text-xs text-neutral-400"
                    >
                        <button
