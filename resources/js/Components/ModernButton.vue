...
const buttonClasses = computed(() => {
    const variants = {
        ...
        secondary: 'bg-primary-50 text-primary-700 hover:bg-primary-100 focus:ring-primary-500 border border-primary-200 hover:border-primary-300',
        accent: 'bg-accent-500 text-white hover:bg-accent-600 focus:ring-accent-500 shadow-soft hover:shadow-soft-md',
        coconut: 'bg-coconut-400 text-coconut-900 hover:bg-coconut-500 focus:ring-coconut-500 shadow-soft hover:shadow-soft-md',
        ghost: 'bg-transparent text-neutral-700 hover:bg-neutral-50 focus:ring-neutral-500 hover:shadow-soft',
        outline: 'border border-neutral-300 bg-white text-neutral-700 hover:bg-neutral-50 focus:ring-primary-500 shadow-soft hover:shadow-soft-md',
    ...
    return [
        ...
        props.loading || props.disabled ? 'cursor-not-allowed' : 'cursor-pointer'
    ];
});
</script>
