...
<template>
    <div class="min-h-screen bg-white overflow-x-hidden">
        ...
        <div
            :class="[
                'fixed inset-y-0 left-0 z-50 bg-white/95 backdrop-blur-xl border-r border-neutral-100 transform transition-all duration-300 ease-in-out',
        ...
        >
            ...
            <div class="border-t border-neutral-50 p-6">
                ...
                >
                    <Cog6ToothIcon
                        class="w-5 h-5 flex-shrink-0 text-neutral-400 group-hover:text-neutral-600"
                    />
                ...
                >
                    <ArrowRightOnRectangleIcon
                        class="w-5 h-5 flex-shrink-0 text-neutral-400 group-hover:text-red-500"
                    />
