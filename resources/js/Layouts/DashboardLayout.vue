...
<template>
    <div class="min-h-screen bg-coconut-100">
        ...
        >
            <!-- Sidebar header -->
            <div
                class="flex items-center justify-between h-16 px-6 border-b border-coconut-200"
            >
                <Link
                    href="/"
                    :class="[
                ...
                >
                    <div
                        class="w-8 h-8 bg-visayan-500 rounded-lg flex items-center justify-center text-white text-sm font-bold"
                    >
                        GC
                    </div>
                    <span v-if="sidebarOpen" class="lg:block"
                        >GeoCasa Bohol</span
                    >
                </Link>
            ...
            <header class="bg-white shadow-soft border-b border-coconut-200">
                <div class="flex items-center justify-between h-16 px-6">
                    ...
                    <div class="flex-1 max-w-lg mx-4">
                        <div class="relative">
                            <MagnifyingGlassIcon
                                class="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-dark-400"
                            />
                            <input
                                type="text"
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative">
                            <button
                                class="p-2 rounded-2xl hover:bg-coconut-200 transition-colors relative"
                            >
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div
                                v-else
                                class="w-8 h-8 bg-visayan-500 rounded-full flex items-center justify-center text-white text-sm font-medium"
                            >
                                U
                            </div>
