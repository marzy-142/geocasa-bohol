...
const verificationSteps = [
    ...
    },
    {
        ...
        description:
            "Full broker dashboard access will be granted upon approval",
        status: "pending",
                    ...
                    >
                        ...
                        <div class="px-8 py-6">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Our admin team is conducting a thorough review
                                of your PRC license, credentials, and
                                documentation to ensure compliance with industry
                                standards. You'll receive an email notification
