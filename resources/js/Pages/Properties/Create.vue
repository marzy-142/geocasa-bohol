<template>
    <ModernDashboardLayout>
        ...
        <form @submit.prevent="submit" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            v-model="form.type"
                            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            :class="{ 'border-red-500 ring-red-500': errors.type }"
                            required
                        >
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div v-if="errors.municipality" class="text-red-500 text-sm mt-1">
                            {{ errors.municipality }}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            :class="{ 'border-red-500 ring-red-500': errors.barangay }"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div>
                        <label for="coordinates_lat" class="block text-sm font-medium text-gray-700 mb-2">
                            Latitude (GPS)
                        </label>
                        <input
                            id="coordinates_lat"
                            ...
                            step="any"
                            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            :class="{ 'border-red-500 ring-red-500': errors.coordinates_lat }"
                            placeholder="e.g., 9.5330"
                        />
                        <div v-if="errors.coordinates_lat" class="text-red-500 text-sm mt-1">
                            {{ errors.coordinates_lat }}
                        </div>
                    </div>

                    <div>
                        <label for="coordinates_lng" class="block text-sm font-medium text-gray-700 mb-2">
                            Longitude (GPS)
                        </label>
                        <input
                            id="coordinates_lng"
                            ...
                            step="any"
                            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            :class="{ 'border-red-500 ring-red-500': errors.coordinates_lng }"
                            placeholder="e.g., 123.7794"
                        />
                        <div v-if="errors.coordinates_lng" class="text-red-500 text-sm mt-1">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        <label for="lot_area_sqm" class="block text-sm font-medium text-gray-700 mb-2">
                            Lot Area (sqm) *
                        </label>
                        <input
                            id="lot_area_sqm"
                            ...
                            step="0.01"
                            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            :class="{ 'border-red-500 ring-red-500': errors.lot_area_sqm }"
                            placeholder="e.g., 1000"
                            required
                            @input="calculateTotalPrice"
                        />
                        <div v-if="errors.lot_area_sqm" class="text-red-500 text-sm mt-1">
                            {{ errors.lot_area_sqm }}
                        </div>
                    </div>

                    <div>
                        <label for="price_per_sqm" class="block text-sm font-medium text-gray-700 mb-2">
                            Price per sqm (₱) *
                        </label>
                        <input
                            id="price_per_sqm"
                            ...
                            step="0.01"
                            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            :class="{ 'border-red-500 ring-red-500': errors.price_per_sqm }"
                            placeholder="e.g., 5000"
                            required
                            @input="calculateTotalPrice"
                        />
                        <div v-if="errors.price_per_sqm" class="text-red-500 text-sm mt-1">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            :class="{ 'border-red-500 ring-red-500': errors.total_price }"
                            placeholder="Auto-calculated"
                            readonly
                        />
                        <div v-if="errors.total_price" class="text-red-500 text-sm mt-1">
                            {{ errors.total_price }}
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="title_type" class="block text-sm font-medium text-gray-700 mb-2">
                            Title Type
                        </label>
                        <select
                            id="title_type"
                            ...
                            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            :class="{ 'border-red-500 ring-red-500': errors.title_type }"
                            required
                        >
                        ...
                        <div v-if="errors.title_type" class="text-red-500 text-sm mt-1">
                            {{ errors.title_type }}
                        </div>
                    </div>

                    <div>
                        <label for="title_number" class="block text-sm font-medium text-gray-700 mb-2">
                            Title Number
                        </label>
                        <input
                            id="title_number"
                            ...
                            type="text"
                            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            :class="{ 'border-red-500 ring-red-500': errors.title_number }"
                            placeholder="e.g., TCT-12345"
                        />
                        <div v-if="errors.title_number" class="text-red-500 text-sm mt-1">
                            {{ errors.title_number }}
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    <label for="zoning_classification" class="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <input
                        ...
                        type="text"
                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                        :class="{ 'border-red-500 ring-red-500': errors.zoning_classification }"
                        placeholder="e.g., Residential, Commercial, Agricultural"
                    />
                    <div v-if="errors.zoning_classification" class="text-red-500 text-sm mt-1">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="nearby_landmarks" class="block text-sm font-medium text-gray-700 mb-2">
                            Nearby Landmarks
                        </label>
                        <textarea
                            id="nearby_landmarks"
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            Separate multiple landmarks with
                            commas
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="url"
                            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                            :class="{ 'border-red-500 ring-red-500': errors.google_maps_link }"
                            placeholder="https://maps.google.com/..."
                        />
                        <div v-if="errors.google_maps_link" class="text-red-500 text-sm mt-1">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        accept="image/*"
                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                        :class="{ 'border-red-500 ring-red-500': errors.images }"
            ...
            >
                <div class="flex justify-end space-x-4">
                    ...
                    >
                        ...
                        <span>{{ processing ? "Creating..." : "Create Property" }}</span>
                    </button>
                </div>
            </div>
        </form>
        ...
        <div class="mt-12 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-8 border border-green-200">
            <div class="text-center">
                <h3 class="text-2xl font-bold text-gray-900 mb-4">
                    🌴 Share Your Bohol Paradise
                </h3>
                <p class="text-gray-600 max-w-2xl mx-auto">
                    Help others discover the beauty of Bohol by listing your property. 
                    From beachfront lots to mountain retreats, every property tells a story.
                </p>
            </div>
        </div>
    </ModernDashboardLayout>
