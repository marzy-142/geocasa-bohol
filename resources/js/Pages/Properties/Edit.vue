            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                >
                    <MapLocationPicker
                        ...
                        :error="
                            form.errors.coordinates_lat ||
                            form.errors.coordinates_lng
                        "
                        @location-selected="onLocationSelected"
                    />
                    <p class="text-xs text-gray-600 mt-2">
                        💡 Tip: Click on the map to set precise coordinates, or
                        search for an address to auto-locate the property.
                    </p>
                </div>
