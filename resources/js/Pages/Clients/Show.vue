                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900">
                                        {{
                                            client.preferred_area_min &&
                                            client.preferred_area_max
                                                ? `${client.preferred_area_min} - ${client.preferred_area_max} hectares`
                                                : client.preferred_area_min
                                                ? `Above ${client.preferred_area_min} hectares`
                                                : client.preferred_area_max
                                                ? `Under ${client.preferred_area_max} hectares`
                                                : "Any size"
                                        }}
                                    </p>
                                </div>
