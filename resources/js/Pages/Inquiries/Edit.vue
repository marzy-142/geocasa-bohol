<template>
    <ModernDashboardLayout title="Edit Inquiry">
        <!-- Header Section -->
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 rounded-lg mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-2">Edit Inquiry</h1>
                    <p class="text-blue-100">Update inquiry details and manage client communication</p>
                </div>
                <div class="text-right">
                    <div class="text-sm text-blue-100">Inquiry ID</div>
                    <div class="text-lg font-semibold">#{{ inquiry.id }}</div>
                </div>
            </div>
        </div>
                ...
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    >
                        ...
                        <button
                            ...
                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded disabled:opacity-50 transition-colors duration-200"
                        >
