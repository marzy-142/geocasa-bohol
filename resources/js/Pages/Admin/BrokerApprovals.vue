...
// Add verification modal function
const openVerificationModal = (broker, credentialType, currentStatus) => {
    selectedBroker.value = broker;
    currentCredential.value = credentialType;
    verificationForm.credential_type = credentialType;
    verificationForm.verified = currentStatus || false;
...
const approveBroker = () => {
    approveForm.post(
        route("admin.broker-approvals.approve", selectedBroker.value.id),
        {
            onSuccess: () => {
...
const rejectBroker = () => {
    rejectForm.delete(
        route("admin.broker-approvals.reject", selectedBroker.value.id),
        {
            onSuccess: () => {
...
const verifyDocument = () => {
    verificationForm.post(
        route("admin.broker-approvals.verify", selectedBroker.value.id),
        {
            onSuccess: () => {
    ...
    <ModernDashboardLayout>
        ...
        >
            ...
            >
                <div class="mt-3">
                    <div
                        class="flex items-center justify-center w-12 h-12 mx-auto bg-blue-100 rounded-full mb-4"
                    >
                        <svg
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button
                            ...
                            class="flex-1 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                        >
                            {{
