                ...
                >
                    <div class="text-center">
                        ...
                        <p class="text-lg text-gray-600 mb-4">
                            Thank you for choosing GeoCasa Bohol to list your
                            property.
                        </p>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    >
                                    <span class="ml-2 text-gray-900">{{
                                        formatPrice(sellerRequest.asking_price)
                                    }}</span>
                                </div>
