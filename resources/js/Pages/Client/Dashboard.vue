...
<template>
    ...
    <ModernDashboardLayout>
        ...
        <div class="relative -mx-6 lg:-mx-8 -mt-6 lg:-mt-8 mb-10 overflow-hidden rounded-b-3xl">
            ...
            <div class="relative z-10 px-6 lg:px-8 py-16">
                <h1 class="text-5xl font-extrabold text-white mb-3 drop-shadow-lg">Welcome Back</h1>
                <p class="text-xl text-blue-50 drop-shadow-md">Here's what's happening with your land search</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            >
                <MagnifyingGlassIcon class="w-10 h-10 mb-4 text-gray-700 group-hover:text-blue-600 transition-colors" />
                <h3 class="text-xl font-bold mb-2 text-gray-900">Browse Land</h3>
            ...
            <Link
                ...
                class="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-blue-500 hover:shadow-lg transition-all duration-300 group"
            >
                <HeartIcon class="w-10 h-10 mb-4 text-gray-700 group-hover:text-blue-600 transition-colors" />
                <h3 class="text-xl font-bold mb-2 text-gray-900">Saved Land</h3>
                <p class="text-gray-600">{{ stats.savedProperties }} favorites</p>
            </Link>
            ...
            <Link
                ...
                class="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-blue-500 hover:shadow-lg transition-all duration-300 group"
            >
                <PlusIcon class="w-10 h-10 mb-4 text-gray-700 group-hover:text-blue-600 transition-colors" />
                <h3 class="text-xl font-bold mb-2 text-gray-900">List My Land</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <!-- Active Inquiries -->
            <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-all duration-300">
                ...
                <p class="text-3xl font-bold text-gray-900 mb-2">{{ stats.activeInquiries }}</p>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-all duration-300">
                ...
                <p class="text-3xl font-bold text-gray-900 mb-2">{{ stats.savedProperties }}</p>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-all duration-300">
                <div class="flex items-center justify-between mb-5">
                    <div class="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center">
                        <ClipboardDocumentListIcon class="w-6 h-6 text-gray-700" />
                    </div>
                    <span
                ...
                <p class="text-3xl font-bold text-gray-900 mb-2">{{ stats.sellerRequests }}</p>
            ...
            <!-- Broker Card -->
            <div v-if="broker" class="bg-gray-900 text-white rounded-xl p-6 hover:shadow-md transition-all duration-300">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div v-if="recommendedProperties && recommendedProperties.length > 0">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 mb-1">Featured Land</h2>
                            <p class="text-sm text-gray-600">Handpicked properties for you</p>
                        </div>
                        <Link
                            :href="route('client.properties')"
                            class="inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-700 font-medium group"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Link
                            v-for="property in recommendedProperties.slice(0, 4)"
                            :key="property.id"
                            :href="route('client.properties.show', property.slug)"
                        ...
                        >
                            <div class="relative aspect-video overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
                                ...
                                <div v-if="property.is_featured" class="absolute top-4 left-4">
                                    <span class="bg-gradient-to-r from-yellow-400 to-yellow-500 text-white text-xs font-bold px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-lg">
                            ...
                            <div class="p-5">
                                <h3 class="font-bold text-lg text-gray-900 mb-3 line-clamp-1 group-hover:text-blue-600 transition-colors">
                                    {{ property.title }}
                                </h3>
                                <div class="flex items-center text-sm text-gray-600 mb-4">
                                    <MapPinIcon class="w-4 h-4 mr-1.5 flex-shrink-0" />
                                    <span class="line-clamp-1">{{ property.municipality }}, Bohol</span>
                                </div>
            ...
            <div class="space-y-6">
                ...
                <div v-if="recentSellerRequests && recentSellerRequests.length > 0" class="bg-white rounded-xl border border-gray-200 p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-lg font-bold text-gray-900">My Listing Requests</h3>
                        <Link
                            :href="route('client.seller-requests.index')"
                    ...
                    <div class="space-y-3">
                        ...
                        >
                            ...
                            <p v-if="request.assigned_broker" class="text-xs text-gray-600">
