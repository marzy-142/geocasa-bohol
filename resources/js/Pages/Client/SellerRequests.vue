        ...
        <div class="max-w-7xl mx-auto">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-2 text-sm text-gray-600">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        >{{ request.address }},
                                        {{ request.municipality }}</span
                                    >
                                </div>

                                <div
                                    v-if="request.price_expectation"
            ...
            >
                ...
                <p class="text-gray-600 mb-6">
                    Own land in Bohol? Submit a listing request and get matched
                    with a professional broker who will help you sell it.
                </p>
                <Link
                    :href="route('client.seller-requests.create')"
