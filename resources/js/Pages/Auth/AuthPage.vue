...
<template>
    ...
    <div class="min-h-screen flex bg-gray-50">
        <!-- Left Side - Branding -->
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-800 via-slate-700 to-slate-600 relative overflow-hidden">
            ...
            <div class="relative flex flex-col justify-center px-12 text-white z-10">
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-white/80 text-sm">Premium property listings</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-2 h-2 bg-amber-400 rounded-full"></div>
                        <span class="text-white/80 text-sm">Licensed broker network</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-2 h-2 bg-amber-400 rounded-full"></div>
                        <span class="text-white/80 text-sm">Advanced search tools</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="mx-auto w-full max-w-md">
                ...
                <div class="lg:hidden flex items-center justify-center gap-3 mb-8">
                    <div class="relative">
                        ...
                        <div class="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-amber-400 rounded-full border border-white flex items-center justify-center">
                            <SunIcon class="w-1.5 h-1.5 text-amber-800" />
                        </div>
                    </div>
                    <div class="text-xl font-bold text-slate-800">
                        GeoCasa <span class="text-amber-600">Bohol</span>
                    </div>
                </div>
                ...
                <div class="relative overflow-hidden">
                    ...
                    <div :class="[
                        ...
                        <!-- Status Message -->
                        <div v-if="status" class="mb-6 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div :class="[
                        'transition-all duration-500 ease-in-out',
                        isRegister ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 absolute inset-0'
                    ]">
                        <div class="text-center mb-6">
                            <h2 class="text-2xl font-bold text-slate-800 mb-1">Create Account</h2>
                            <p class="text-slate-600 text-sm">Join our real estate community</p>
                        </div>
                        ...
                        <form @submit.prevent="submitRegister" class="space-y-4">
                                        ...
                                        <div :class="[
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div :class="[
                                                    ...
                                                    <div v-if="registerForm.role === 'client'" class="w-1.5 h-1.5 bg-white rounded-full"></div>
                                                </div>
                                                <UserGroupIcon class="w-4 h-4 text-slate-600" />
                                                <div>
                                                    <div class="font-medium text-slate-800 text-sm">Regular User</div>
                                                    <div class="text-xs text-slate-600">Browse and inquire about properties</div>
                                                </div>
                                            </div>
                                        </div>
                                    </label>
                                        ...
                                        <div :class="[
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div :class="[
                                                    ...
                                                    <div v-if="registerForm.role === 'broker'" class="w-1.5 h-1.5 bg-white rounded-full"></div>
                                                </div>
                                                <BriefcaseIcon class="w-4 h-4 text-amber-600" />
                                                <div>
                                                    <div class="font-medium text-slate-800 text-sm">Real Estate Broker</div>
                                                    <div class="text-xs text-slate-600">List and sell properties (requires verification)</div>
                                                </div>
                                            </div>
                                        </div>
                                    </label>
                            ...
                            <!-- Broker Credentials -->
                            <div v-if="registerForm.role === 'broker'" class="space-y-4 p-4 bg-gray-50 rounded-lg border">
                                ...
                                <FileUpload
                                    ...
                                    accept=".pdf,.jpg,.jpeg,.png"
                                    :error="registerForm.errors.business_permit_file"
                                />

                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                    <p class="text-xs text-blue-800">
                                        Your broker application will be reviewed by our admin team.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <button
                                    ...
                                    class="absolute right-3 top-9 text-slate-400 hover:text-slate-600"
                                >
                                    <EyeIcon v-if="!showPasswordConfirmation" class="w-4 h-4" />
                                    <EyeSlashIcon v-else class="w-4 h-4" />
                                </button>
                            </div>
