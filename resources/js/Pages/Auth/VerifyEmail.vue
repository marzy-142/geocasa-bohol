...
const canResend = computed(() => {
    ...
    const timeSinceLastResend = Date.now() - lastResendTime.value;
...
<template>
    ...
    <div
        class="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8"
    >
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                <div class="flex justify-center mb-6">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-primary-500 to-accent-500 rounded-2xl flex items-center justify-center shadow-lg"
                    >
                        <svg
            ...
            <!-- Form -->
            <div
                class="bg-white rounded-2xl shadow-xl p-8 border border-neutral-100"
            >
                <!-- Email Instructions -->
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <ModernButton
                        ...
                        :disabled="form.processing || !canResend"
                    >
            ...
            <div class="bg-neutral-50 rounded-xl p-6 border border-neutral-200">
                <h3 class="text-neutral-900 font-medium text-sm mb-2">
            ...
            <div class="text-center">
                <p class="text-neutral-500 text-xs">
                    © 2024 GeoCasa Bohol. Your trusted real estate partner in
                    Bohol.
                </p>
            </div>
        </div>
